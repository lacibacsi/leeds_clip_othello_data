...
# original code taken from https://github.com/kevannguyen/Othello
...
class OthelloGame:
    ...
    def current_board_as_vector(self) -> np.array:
        '''
        vector representation of the board for clip training
        :return: 8x8x2 numpy array, for black and for white disc positions respectively
        '''

        black = np.array(self.current_board)
        white = np.array(self.current_board)
        black[black == '.'] = 0
        black[black == 'W'] = 0
        black[black == 'B'] = 1
